...
<body>
  ...
  <section class="hero">
    <header>
      <img class="logo" src="Assets/logo.png.png" alt="AgriGuide Logo">
    </header>
    ...
    <div class="hero-links">
      <a href="cropinfo.html" class="link">
  ...
  <section class="contact-section">
    <div class="contact-card">
      <div class="contact-left">
        <h2>Contact Us</h2>
        <div class="about-underline"></div>
        <p>Have questions or need help? Reach out to our team and we will get back to you as soon as possible.</p>
        <div class="contact-info">
          <div class="contact-item">
            <i class="fa-solid fa-location-dot contact-icon"></i>
            <span>University Campus, Lahore, Pakistan</span>
          </div>
          <div class="contact-item">
            <i class="fa-solid fa-envelope contact-icon"></i>
            <span>support@agriguide.pk</span>
          </div>
          <div class="contact-item">
